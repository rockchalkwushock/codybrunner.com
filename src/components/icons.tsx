...
export const CoffeeIcon = component$<IconProps>(({ class: cls }) => {
	return (
		<svg
			aria-hidden='true'
			class={cx(
				'h-6 w-6 fill-none duration-100 ease-in-out stroke-primary-500 transition-all lg:group-hover:scale-125 lg:group-hover:animate-wiggle group-hover:stroke-accent-500 dark:stroke-primary-400 dark:group-hover:stroke-accent-400',
				cls
			)}
			stroke-linecap='round'
			stroke-linejoin='round'
