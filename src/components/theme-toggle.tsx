...
export const ThemeToggle = component$(() => {
	...
	return (
		<button
			...
			class='group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-slate-800/5 ring-1 ring-slate-900/5 backdrop-blur transition dark:bg-slate-800/90 dark:ring-white/10 dark:hover:ring-white/20'
			onClick$={toggleTheme$}
			type='button'
		>
			<SunIcon />
