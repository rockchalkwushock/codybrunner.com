...
export function ThemeToggle(): JSX.Element {
  ...
  return (
    <button
      className="group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-primary-800/5 ring-1 ring-primary-900/5 backdrop-blur transition dark:bg-primary-800/90 dark:ring-white/10 dark:hover:ring-white/20 pointer-events-auto"
      onClick={handleClick}
    >
      <SunIcon />
      <MoonIcon />
