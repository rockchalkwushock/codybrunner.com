...
export const translations: Schema = {
	...
	es: {
		...
		'about.content.paragraph-three':
			'Conocí al amor de mi vida aquí en las "inter-tubes" en 2014 en un chat de intercambio de idiomas. Después de muchos años de ser amigos tuvimos la oportunidad de conocernos en persona en 2019 y empezamos a salir. Atamos el nudo aquí en su país natal de Colombia en 2020 y ha sido el hogar desde entonces. Cuando no estoy trabajando me gusta pasar tiempo con mi esposa, levantar pesas, viajar, aprender guitarra, juguetear con mi Raspberry Pi y ahumar carnes y quesos.',
		'about.content.title':
			'Soy Cody Brunner. Vivo en Bogotá, Colombia, donde trabajo en el software del futuro.',
		'about.metadata.description':
			'Cody Brunner es un expatriado estadounidense que vive en Bogotá, Colombia. Sirvió en la Marina de los Estados Unidos y una vez en Afganistán. Es Desarrollador Frontend Senior en WAO Fintech, la primera y más confiable plataforma cripto IRA del mundo. Trabaja principalmente con GraphQL, ReactJS y TypeScript. También contribuye a la comunidad de código abierto. Otras tecnologías con las que trabaja incluyen Astro, Elixir, Golang, NextJS, Phoenix, Python, Qwik, ReactJS, Rust, SolidJS, tRPC y TypeScript.',
		...
		'home.hero.description':
			'Hola, soy Cody, un cristiano, veterano de la Marina de los Estados Unidos, Jayhawk, y un expatriado estadounidense que vive en las afueras de Bogotá, Colombia. Trabajo como Desarrollador Frontend Senior en WAO Fintech, donde somos pioneros en la primera y más confiable plataforma cripto IRA del mundo. Cuando no estoy trabajando me pueden encontrar en el gimnasio, enseñándome guitarra, explorando Colombia, o ahumando unas costillas.',
		'home.hero.heading':
		...
		'nav.articles.label': 'Ir a blog.codybrunner.com.',
