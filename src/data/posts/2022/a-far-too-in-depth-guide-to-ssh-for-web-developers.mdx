---
assetPath: /assets/icons/terminal.svg
author: Cody Brunner
category: technology
coverImage: ~
...
This will pipe the output of the file to the clipboard. Navigate to the following [page](https://github.com/settings/keys) on your GitHub Settings. Then select add an _New SSH Key_ and paste the public key into the ssh-config area and click _Add SSH Key_.

> NOTE: You should **NOT** see either of the following in what you paste. If you do, you have copied the private key by accident and should **NOT** add the key. Instead clear the ssh-config area and go back to your terminal to copy the correct file.
