...
export const USES = {
	...
	workStation: [
		...
		},
		{
			...
			href: 'https://www.autonomous.ai/standing-desks/smartdesk-2-home?purchase_method=1',
		...
		},
		{
			...
			href: 'https://www.autonomous.ai/sale/evergreen-ergochair-pro-for-sale?purchase_method=1',
