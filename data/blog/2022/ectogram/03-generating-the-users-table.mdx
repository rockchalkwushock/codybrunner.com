...
For brevity I removed a lot of the validations that are being ran to condense this section down you can view the whole file [here](https://github.com/
rockchalkwushock/ectogram/blob/production/lib/ectogram/user.ex#L41).
