...
The site is currently written in `next@^12.X` and styled using `tailwindcss@^3.X`. If you feel like taking a look at the source code you can check it out [here](https://github.com/rockchalkwushock/codybrunner.com).
